...
class TestInvokerCheckoutCommit(unittest.TestCase):
    ...
    def test_invoker_00(self, mock_run):
        response = make_invoker_cmd_call(invoker=RequestTypeToInvoker[backend_pb2.CMD_BRANCH_CHECKOUT],
                                         sandbox_root=self._sandbox_root,
                                         req_type=backend_pb2.CMD_BRANCH_CHECKOUT,
